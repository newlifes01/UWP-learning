...
namespace AmCharts.Windows.QuickCharts
{
    ...
    public class SerialChart : Control
    {
        ...
        private void AddIndicator(SerialGraph graph)
        {
            ...
            indicator.ManipulationMode = ManipulationModes.All;
            indicator.ManipulationStarted += OnIndicatorManipulationStarted;
        ...
        void OnIndicatorManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
        ...
        private void AssignGraphCanvas()
        {
            ...
            _graphCanvas.ManipulationMode = ManipulationModes.All;
            _graphCanvas.ManipulationStarted += OnGraphCanvasManipulationStarted;
        }
        ...
        private void AssignGridParts()
        {
            ...
            _categoryAxis.ManipulationMode = ManipulationModes.All;
            _categoryAxis.ManipulationStarted += OnGridManipulationStarted;
            _valueAxis.ManipulationMode = ManipulationModes.All;
            _valueAxis.ManipulationStarted += OnGridManipulationStarted;
        }
        void OnGridManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
            if (_legend != null)
            {
        ...
        private void AssignLegend()
        {
            ...
            _legend.ManipulationMode = ManipulationModes.All;
            _legend.ManipulationStarted += OnGridManipulationStarted;
        }
        ...
        void OnGraphCanvasManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
            if (_balloon != null)
            {
                _balloon.Visibility = Visibility.Collapsed;
            }
            PositionIndicators(e.Position);
            SetToolTips(e.Position);
        }
